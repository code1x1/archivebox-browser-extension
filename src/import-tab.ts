...
export async function initializeImport() {
    ...
    document
        .getElementById('importFilter')
        .addEventListener('input', filterImportItems)
    document
        .getElementById('showNewOnly')
        .addEventListener('change', filterImportItems)
    document
        .getElementById('selectAll')
        .addEventListener('click', () => toggleAllSelection(true))
    document
        .getElementById('deselectAll')
        .addEventListener('click', () => toggleAllSelection(false))
    document
        .getElementById('selectAllHeader')
        .addEventListener('change', (e) => toggleAllSelection(e.target.checked))
    document
        .getElementById('importSelected')
        .addEventListener('click', importSelected)
}
...
function updateSelectedCount() {
    const visibleSelected = Array.from(
        document.getElementById('importTable').querySelectorAll('tbody tr')
    ).filter(
        (row) =>
            row.style.display !== 'none' &&
